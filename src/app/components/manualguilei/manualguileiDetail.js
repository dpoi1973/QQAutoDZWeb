...
class manualguileiDetailController extends baseDetailComponent {
  // @ngInject
  constructor(CommonUtilsService, $stateParams, $log, $uibModal, $state, $window) {
    super($log, CommonUtilsService, 'manualcustproductdetail', $stateParams.id);
    this.$state = $state;
    this.$window = $window;
    this.getdetailinfo();
...
export const manualguileiDetailcomponent = {
  template: require('./manualguileiDetail.html'),
  controller: manualguileiDetailController
};
